...
---
# Robotics Foundation Week 4: ROS and Hardware Control.
  This session is intended for the students to learn how to control external hardware using rosserial tools that will be required in the following sessions. 

  ## Session 1
  * In this session, the concepts of open loop control and system identification will be shown.
  * Some robotic sensors (encoders) and its applications will be shown.
  
  ## Session 2
  * Q&A Session for the Final Challenge.

  ## Mini challenge
  * Control in open loop the speed and direction of a motor using a MCU, controlled from a computer using rosserial.
